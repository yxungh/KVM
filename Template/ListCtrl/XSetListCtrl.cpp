...
void XSetListCtrl::SetListCheckItem(CListCtrl* pListCtrl,int nItem)
{
	pListCtrl->SetCheck(nItem);
}

void XSetListCtrl::SetListCheckItemFalse(CListCtrl* pListCtrl,int nItem)
{
	pListCtrl->SetCheck(nItem,FALSE);
}
...
CString XSetListCtrl::GetColumnText(CListCtrl* pListCtrl,int nItem,int nSubItem)
{
	return pListCtrl->GetItemText(nItem,nSubItem);
}
