...
{
	m_szTitle=XTranslationManage::GetInstance()->GetTranslationString(_T("5"));
}
...
{
	return MessageBox(XTranslationManage::GetInstance()->GetTranslationString(szTextKey,szDefault),m_szTitle,uType);
}
