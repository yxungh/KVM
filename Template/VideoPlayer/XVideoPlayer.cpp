...
//void XVideoPlayer::SetPreviewPan(XVideoPreviewPane* pan)
//{
//	m_PreviewPan=pan;
//}
...
void XVideoPlayer::SetRTSPHWNDBGColor(HWND h,Uint8 r,Uint8 g,Uint8 b)
{
	...
	if(NULL!=pRTSPHWND)
	{
		pRTSPHWND->SetBGColor(r,g,b,255);
	}
...
void XVideoPlayer::AdjustMultiVideoWindowSize(XMultiVideoWindow* p,int nWidth,int nHeight)
{
...
void XVideoPlayer::InitData()
{
	...
	//设置字体
	SetFontPath(HandlePath::GetFontPath(_T("msyh.ttf")));
}
...
void XVideoPlayer::Quit()
{
	...
	//m_PreviewPan->ClearRTSPAddrCount();
...
void XVideoPlayer::HandleRTSPShow()
{
	...
	for(MAP_RTSP::iterator iter=m_MapRTSP.begin(); iter!=m_MapRTSP.end();)
	{
		...
		unsigned int nShowCount=pRTSP->GetCount();
...
//void XVideoPlayer::GetShowCount(MAP_RTSPADDRSHOWCOUNT& MapCount, BOOL bShowState, BOOL bSignalControl)
//{
//	CString szRTSPAddr = m_szRTSPAddr;
//
//	if (szRTSPAddr == _T(""))
//	{
//		return;
//	}
//
//	unsigned int nShowCount = bShowState ? 0x10000 : 0;
//
//	MAP_RTSPADDRSHOWCOUNT::iterator iterMap = MapCount.find(szRTSPAddr);
//
//	if (MapCount.end() != iterMap)
//	{
//		unsigned int nCount = iterMap->second;
//
//		nCount++;
//
//		nCount+= nShowCount;
//
//		iterMap->second = nCount;
//	}
//	else
//	{
//		MapCount.insert(std::pair<CString, int>(szRTSPAddr, 1 + nShowCount));
//	}
//}

//
//unsigned int XVideoPlayer::GetCount(MAP_RTSPADDRSHOWCOUNT& MapCount, CString szRTSPAddr)
//{
//	//unsigned nCount = 0;
//
//	//MAP_RTSPADDRSHOWCOUNT::iterator iterMap = MapCount.find(szRTSPAddr);
