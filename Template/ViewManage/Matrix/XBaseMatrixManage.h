...
class XBaseMatrixManage:public XBaseViewManage
{
public:
	XBaseMatrixManage();
	virtual ~XBaseMatrixManage();
...
public:
	inline void SetDelegate(XDelegateMatrixManage* p){m_pDelegate=p;}



public:

	XDelegateMatrixManage* m_pDelegate=NULL;
